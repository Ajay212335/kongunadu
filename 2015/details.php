...
?>
    ...
    <div class="wii">
        <div class="will">
            ...
            <div class="form-group">
            <input type="text" class="form-control"  name="register_number" placeholder="Register Number: ">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
            <select type="text" class="FILL"   name="work" placeholder="Working:">
            ...
            <div class="form-group">
            <input type="text" class="form-control"  name="status" placeholder="Stattus">
            </div>
            <br>
            <input type="submit" class="joy" value="Register">
                
            </form>
            <div class="joyboy">
            
            <a href="logout.php" class="boy">Logout</a>
          </div>
        </div>
        </div>
    </div>
